...
async def _handle_rpc(payload: Any, client: ZoteroClient) -> dict[str, Any] | None:
    ...
    if method == "initialize":
        return {"jsonrpc": "2.0", "id": request_id, "result": {"protocolVersion": PROTOCOL_VERSION, "capabilities": {"tools": {"listChanged": False}}, "serverInfo": {"name": "zotero-chatgpt-mcp", "version": "0.2.2"}}}
